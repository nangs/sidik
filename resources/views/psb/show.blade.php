...
@section('content')
	...
	<div class="pull-right">
		...
		<a href="/psb/edit-form-daftar/{{ $psb->id }}" class="btn btn-success"><span class="fa fa-edit"></span> Edit Data PSB</a>
		@endif
		@if ($psb->status_progress == \App\Psb::STATUS_BAYAR_OK)
		<a href="/psb/isi-formulir/{{ $psb->id }}" class="btn btn-success"><span class="fa fa-edit"></span> Isi Formulir</a>
		@endif
