{!! Form::model($formWawancaraCalonSantri, ['url' => $url, 'class' => 'form-horizontal', 'method' => $method]) !!}

	<div class="form-group">
		{!! Form::label('indikator_variable', 'Indikator Variable:', ['class' => 'col-md-2 control-label']) !!}
		<div class="col-md-10">
			{!! Form::text('indikator_variable', $formWawancaraCalonSantri->indikator_variable, ['class' => 'form-control', 'placeholder' => 'Indikator Variable']) !!}
		</div>
	</div>

	<div class="form-group">
		{!! Form::label('sub_indikator_variable', 'Sub Indikator Variable:', ['class' => 'col-md-2 control-label']) !!}
		<div class="col-md-10">
			{!! Form::text('sub_indikator_variable', $formWawancaraCalonSantri->sub_indikator_variable, ['class' => 'form-control', 'placeholder' => 'Sub Indikator Variable']) !!}
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-md-10">
			{!! Form::text('pertanyaan', $formWawancaraCalonSantri->pertanyaan, ['class' => 'form-control', 'placeholder' => 'Pertanyaan']) !!}
		</div>
	</div>
	...
	<table class="table table-striped table-hover">
		...
		<tbody id="jawaban">
			@foreach ($formWawancaraCalonSantri->jawaban as $j)
			<tr>
